...
var Ghadyaal = function (_React$Component) {
  _inherits(Ghadyaal, _React$Component);

  function Ghadyaal(props) {
    _classCallCheck(this, Ghadyaal);

    var _this = _possibleConstructorReturn(this, (Ghadyaal.__proto__ || Object.getPrototypeOf(Ghadyaal)).call(this, props));
  ...
  _createClass(Ghadyaal, [{
    ...
    key: 'getCoordinates',
    value: function getCoordinates(timeInt) {
      var tensCoords = {
        0: [],
      ...
      var tens = Math.floor(timeInt / 16);
      var sw = timeInt % 16 % 4;
      var ne = Math.floor(timeInt % 16 / 4);
    ...
    key: 'createLines',
    value: function createLines(coordinates) {
      var _this2 = this;

      return coordinates.map(function (coordinate) {
        return _react2.default.createElement('line', { className: 'line',
          key: _this2.state.now + "_" + Math.random().toString(),
          x1: coordinate[0].toString(),
          y1: coordinate[1].toString(),
          x2: coordinate[2].toString(),
          y2: coordinate[3].toString(),
          style: {
            strokeWidth: coordinate[4] * _this2.props.baseStrokeWidth,
    ...
    value: function render() {
      var secondsLines = this.createLines(this.getCoordinates(this.state.now.seconds()));
      var minutesLines = this.createLines(this.getCoordinates(this.state.now.minutes()));
      var hoursLines = this.createLines(this.getCoordinates(this.state.now.hours()));
      ...
      return _react2.default.createElement(
        'div',
        { id: 'timers', style: timersStyle },
        _react2.default.createElement(
          'svg',
          { id: 'hours', className: 'timer',
            style: timerStyle,
